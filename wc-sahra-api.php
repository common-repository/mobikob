...
class WC_REST_Custom_Controller{
     ...
     */
    public function get_SahraLastOrder($request_data) {
     ...
     */
    public function get_SahraCustomer($request_data) {
        $parameters = $request_data->get_params();
        if (isset($parameters['phone'])){
            $args = array (
                'order' => 'DESC',
     ...
     */
    public function get_SahraOrderByMeta($request_data) {
        $parameters = $request_data->get_params();
    ...
    public function register_routes() {
        register_rest_route(
            ...
            array(
                'methods' => 'GET',
                'callback' => array( $this, 'get_SahraCustomer' ),
            )
        );
        ...
        register_rest_route(
            ...
            array(
                'methods' => 'GET',
                'callback' => array( $this, 'get_SahraOrderByMeta' ),
            )
        );
        ...
        register_rest_route(
            ...
            array(
                'methods' => 'GET',
                'callback' => array( $this, 'get_SahraLastOrder' ),
            )
        );
    }
}
